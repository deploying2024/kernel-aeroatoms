  ...
  {isWide && (
    <div className="overflow-hidden">
      ...
      >
        ...
        {/* ── Bottom ── */}
        <div
          className="px-2 py-4 space-y-2 border-t"
          style={{ borderColor: 'var(--border-dim)' }}
        >
          {/* Theme toggle */}
          ...
          <button
            ...
            onMouseEnter={e => {
              ...
              ;(e.currentTarget as HTMLElement).style.background = '#ff006e08'
            }}
            onMouseLeave={e => {
...
{!mobile && (
  <div
    className="hidden md:flex items-center justify-end px-2 py-2 border-t"
    style={{ borderColor: 'var(--border-dim)' }}
  >
    <button
      onClick={() => setCollapsed(!collapsed)}
      className={cn(
        'flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium border transition-all duration-200 w-full',
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'hidden md:flex flex-col shrink-0 h-screen sticky top-0 transition-all duration-300 ease-in-out relative z-30',
      ...
      >
        <div className="flex items-center gap-2">
          ...
          >
            <Plane className="w-3.5 h-3.5" style={{ color: 'var(--accent)' }} />
          </div>
          <span
